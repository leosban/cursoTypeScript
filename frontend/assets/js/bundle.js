...
/***/ "./src/A0020-exercise/form-control.ts":
/*!********************************************!*\
  !*** ./src/A0020-exercise/form-control.ts ***!
  \********************************************/
...
function checkForEmptyFields() {
    ...
    inputs.forEach(function (input) {
        if (!input.value)
            showErrorMessage(input, 'Field cannot be empty');
    });
}
...
function shouldSendForm(form) {
    ...
    form
        ...
        .querySelectorAll('.' + SHOW_ERROR_MESSAGES)
        .forEach(function (element) { return (send = false); });
    return send;
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/A0020-exercise/form-control.ts");
